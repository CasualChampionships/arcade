...
import net.casual.arcade.dimensions.border.state.BorderState
import net.casual.arcade.dimensions.border.state.CenterBorderState
import net.casual.arcade.dimensions.border.state.StillBorderState
import net.casual.arcade.dimensions.border.state.StillCenterBorderState
import java.util.*
