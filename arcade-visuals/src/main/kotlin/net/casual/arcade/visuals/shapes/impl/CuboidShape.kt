...
public class CuboidShape(
    ...
    override fun iterator(pointsPerUnit: Double): Iterator<Vec3> {
        return CuboidShapeIterator(this.aabb, pointsPerUnit)
    }

    private class CuboidShapeIterator(
        ...
        constructor(aabb: AABB, pointsPerUnit: Double): this(aabb.minPosition, aabb.maxPosition, pointsPerUnit)
