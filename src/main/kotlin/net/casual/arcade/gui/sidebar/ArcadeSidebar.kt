...
public class ArcadeSidebar(title: PlayerSpecificElement<Component>): PlayerUI(), TickableUI {
    private val rows = ArrayList<PlayerSpecificElement<SidebarComponent>>(SidebarUtils.MAX_SIZE)
