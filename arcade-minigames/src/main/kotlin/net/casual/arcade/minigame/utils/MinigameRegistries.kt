...
public object MinigameRegistryKeys: RegistryKeySupplier(ArcadeUtils.MOD_ID) {
    ...
    public val MINIGAME_DATA_PROVIDER: ResourceKey<Registry<MinigameDataProvider<*>>> = create("minigame_data_provider")
...
public object MinigameRegistries: RegistrySupplier() {
    ...
    public val MINIGAME_DATA_PROVIDER: Registry<MinigameDataProvider<*>> = create(MinigameRegistryKeys.MINIGAME_DATA_PROVIDER, MinigameDataProvider.Companion::bootstrap)
