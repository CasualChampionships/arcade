...
private val SPLIT_TEXTURE = IdentifierUtils.arcade("font/split.png")
private val NO_SPLIT_TEXTURE = IdentifierUtils.arcade("font/no_split.png")
...
public object PaddingSplitFontResources: IndexedFontResources(IdentifierUtils.arcade("padding_split")) {
    init {
        for (i in SIZE_RANGE) {
            if (i != 0) {
...
public object PaddingNoSplitFontResources: IndexedFontResources(IdentifierUtils.arcade("padding_no_split")) {
    init {
        for (i in SIZE_RANGE) {
            if (i != 0) {
