...
dependencies {
    include(implementation("net.casualchampionships:arcade-minigames:0.9.0-beta.1+26.1-pre-2")!!)

    include(modImplementation("net.casualchampionships:arcade-commands:0.9.0-beta.1+26.1-pre-2")!!)
    include(modImplementation("net.casualchampionships:arcade-dimensions:0.9.0-beta.1+26.1-pre-2")!!)
    ...
    include(modImplementation("net.casualchampionships:arcade-guis:0.9.0-beta.1+26.1-pre-2")!!)
    include(modImplementation("net.casualchampionships:arcade-replay:0.9.0-beta.1+26.1-pre-2")!!)
    ...
    include(modImplementation("net.casualchampionships:arcade-visuals:0.9.0-beta.1+26.1-pre-2")!!)
