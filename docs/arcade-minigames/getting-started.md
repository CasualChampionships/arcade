...
dependencies {
    include(implementation("net.casualchampionships:arcade-minigames:0.9.0-beta.3+26.1")!!)

    include(modImplementation("net.casualchampionships:arcade-commands:0.9.0-beta.3+26.1")!!)
    include(modImplementation("net.casualchampionships:arcade-dimensions:0.9.0-beta.3+26.1")!!)
    ...
    include(modImplementation("net.casualchampionships:arcade-guis:0.9.0-beta.3+26.1")!!)
    include(modImplementation("net.casualchampionships:arcade-replay:0.9.0-beta.3+26.1")!!)
    include(modImplementation("net.casualchampionships:arcade-resource-pack:0.9.0-beta.3+26.1")!!)
    include(modImplementation("net.casualchampionships:arcade-scheduler:0.9.0-beta.3+26.1")!!)
    include(modImplementation("net.casualchampionships:arcade-utils:0.9.0-beta.3+26.1")!!)
    include(modImplementation("net.casualchampionships:arcade-visuals:0.9.0-beta.3+26.1")!!)
}
```
