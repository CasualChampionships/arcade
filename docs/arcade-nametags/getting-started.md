...
dependencies {
    include(implementation("net.casualchampionships:arcade-nametags:0.9.0-beta.8+26.1")!!)
    ...
    include(implementation("net.casualchampionships:arcade-virtual-entities:0.9.0-beta.8+26.1")!!)
}
```
