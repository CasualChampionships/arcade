...
dependencies {
    include(implementation("net.casualchampionships:arcade-visuals:0.9.0-beta.3+26.1")!!)
    ...
    include(modImplementation("net.casualchampionships:arcade-nametags:0.9.0-beta.3+26.1")!!)
    ...
    include(modImplementation("net.casualchampionships:arcade-virtual-entities:0.9.0-beta.3+26.1")!!)
}
```
