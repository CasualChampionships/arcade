...
public class ChunkArea(
     ...
     */
    public fun contains(level: ResourceKey<Level>, pos: ChunkPos): Boolean {
     ...
     */
    public fun intersects(level: ResourceKey<Level>, box: BoundingBox): Boolean {
    ...
    public companion object {
        public fun of(level: ServerLevel, x: Int, z: Int, radius: Int): ChunkArea {
            return ChunkArea(
                level,
